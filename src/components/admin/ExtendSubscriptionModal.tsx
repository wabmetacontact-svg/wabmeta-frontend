                            ...
                            {quickOptions.map((days) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 text-sm rounded-lg border transition-colors ${additionalDays === days
                                        ...
                                        : 'bg-white text-gray-300 border-gray-200 hover:border-green-400'
                                        }`}
                                >
                                    +{days} days
                                </button>
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-2">
                            <input
                                ...
                                min={1}
                                max={730}
                                className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 bg-white text-gray-900"
                            />
