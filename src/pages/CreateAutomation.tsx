    ...
    <div className="space-y-6 transition-colors">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Design your automated message sequence</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none"
                />
              </div>
               ...
               {formData.trigger === 'UNKNOWN_MESSAGE' && (
                 <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
                   <label className="flex items-center gap-3 cursor-pointer group">
                      ...
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-gray-900 transition-colors">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-6">
                    ...
                    <button
                      ...
                      className={`flex items-start gap-3 p-4 rounded-xl border text-left transition-all ${
                        isSelected
                          ...
                          : 'border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 hover:border-blue-200 dark:hover:border-blue-900'
                      }`}
                    >
                      <div className={`p-2 rounded-lg ${isSelected ? 'bg-blue-500 text-white' : 'bg-white dark:bg-gray-800 text-gray-400'}`}>
                        <Icon className="w-5 h-5" />
                      </div>
                      <div>
                        <p className={`text-sm font-bold ${isSelected ? 'text-blue-900 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'}`}>
                          {opt.label}
                        </p>
              ...
              {formData.trigger === 'KEYWORD' && (
                <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-800 animate-in fade-in slide-in-from-top-2 duration-300">
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Keyword(s)</label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="exactMatch" className="text-xs font-medium text-gray-600 dark:text-gray-400 cursor-pointer">Exact match only</label>
                  </div>
                </div>
              )}

              {formData.trigger === 'SCHEDULE' && (
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-800 animate-in fade-in slide-in-from-top-2 duration-300">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Recursion</label>
                    <select
          ...
          {/* Actions List */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 py-2">
              <ChevronRight className="w-5 h-5 text-gray-400 rotate-90" />
              Response Workflow
            </h3>
            
            {actions.length === 0 ? (
              <div className="p-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-3xl flex flex-col items-center justify-center text-center opacity-60">
                 <div className="w-16 h-16 bg-gray-50 dark:bg-gray-900 rounded-2xl flex items-center justify-center mb-4">
                    <Plus className="w-8 h-8 text-gray-300" />
                 </div>
                 <p className="font-bold text-gray-700 dark:text-gray-300">Your workflow is empty</p>
              ...
              <div className="space-y-4 relative">
                {/* Visual Line */}
                <div className="absolute left-10 top-0 bottom-0 w-0.5 bg-gray-100 dark:bg-gray-800 -z-10" />
                ...
                {actionOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 hover:bg-white dark:hover:bg-gray-800 transition-all hover:shadow-lg group"
                    >
                      <div className="p-2 bg-white dark:bg-gray-900 rounded-xl shadow-sm group-hover:bg-blue-500 group-hover:text-white transition-colors">
                        <Icon className="w-5 h-5" />
                      </div>
                      <span className="text-[10px] font-bold text-gray-600 dark:text-gray-400 text-center tracking-tight leading-tight">
                        {opt.label}
                      </span>
                    </button>
                  );
  ...
  return (
    <div className="flex gap-4 group animate-in slide-in-from-left-4 duration-500">
      <div className="flex-none">
        <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 flex items-center justify-center font-bold text-xs shadow-sm shadow-blue-500/10">
          {index + 1}
        </div>
      </div>
      
      <div className="flex-1 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden border-l-4 border-l-blue-500 group-hover:shadow-md transition-shadow">
        <div className="p-4 flex items-center justify-between bg-gray-50/50 dark:bg-gray-800/30 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3">
            <div className="p-1.5 bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-lg">
              <Icon className="w-4 h-4" />
            </div>
            <h4 className="text-sm font-bold text-gray-900 dark:text-white">{option?.label}</h4>
          </div>
          <button
          ...
          {action.type === 'send_text' && (
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
          )}
          ...
          {action.type === 'send_template' && (
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-sm outline-none"
                />
              </div>
              <div className="flex-1">
