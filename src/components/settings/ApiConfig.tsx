    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-medium text-slate-800">API Keys</h3>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1.5">
                <code className="text-sm text-slate-800 bg-white px-2 py-1 rounded border border-slate-200/50 font-mono">
                  {showSecret ? 'wm_live_sk_xxxxxxxxxxxxx' : 'wm_live_sk_••••••••••••'}
                </code>
                <button
                  onClick={() => setShowSecret(!showSecret)}
                  className="ml-2 p-1 text-slate-500 hover:text-slate-700 transition-colors"
                >
      ...
      <div>
        <h3 className="font-medium text-slate-800 mb-4">Webhook Configuration</h3>
