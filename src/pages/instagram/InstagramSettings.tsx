...
const InstagramSettings: React.FC = () => {
  // Placeholder - real connection state comes from the API.
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-10">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage your connected accounts and API permissions</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="relative rounded-2xl bg-gray-50 border border-gray-200 p-6 overflow-hidden">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${isConnected ? 'bg-green-500/20' : 'bg-gray-50'}`}>
                ...
                <div className="p-4 rounded-xl bg-green-500/5 border border-green-500/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <img src="https://via.placeholder.com/40" className="w-10 h-10 rounded-full border border-gray-200" alt="Profile" />
                      <div>
                        <p className="text-sm font-bold text-gray-900">@wabmeta_official</p>
          ...
          <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">API Permissions</h3>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-gray-200 p-5">
            <div className="flex items-center gap-2 mb-3">
              <Shield className="w-4 h-4 text-indigo-400" />
              <h4 className="text-sm font-bold text-gray-900">Pre-requisites</h4>
            </div>
          ...
          <div className="rounded-2xl bg-gray-50 border border-gray-200 p-5">
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center justify-between p-2 text-xs text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all">
