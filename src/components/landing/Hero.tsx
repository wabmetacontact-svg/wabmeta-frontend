...
const Hero = () => {
  return (
    ...
    >
      {/* Very light tint — sirf thoda sa readability ke liye, background clearly dikhe */}
      <div className="absolute inset-0 bg-white/10" />

      {/* Subtle vignette — corners thode darker, center clear */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#1e3a5f]/10 via-transparent to-[#1e3a5f]/10" />
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/60 bg-white/80 px-4 py-1.5 text-sm font-semibold text-[#1e3a5f] shadow-md backdrop-blur-md"
            >
              <Sparkles className="h-4 w-4 text-[#2883CF]" />
              Official Meta WhatsApp Business Partner
            </motion.div>

            {/* Heading — strong navy for readability on light bg */}
            <h1 className="mt-6 text-4xl font-extrabold leading-tight tracking-tight text-[#0f2540] sm:text-5xl lg:text-6xl drop-shadow-sm">
            ...
            {/* Sub heading — slight white glass behind text for readability */}
            <p className="mt-6 text-lg leading-relaxed text-gray-800 sm:text-xl">
              ...
              <span className="font-bold text-[#1e3a5f]">WhatsApp Cloud API</span>{' '}
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3 lg:justify-start">
              {[
                ...
                <div
                  key={i}
                  className="inline-flex items-center gap-1.5 rounded-full border border-white/70 bg-white/85 px-3.5 py-1.5 text-sm font-semibold text-[#1e3a5f] shadow-sm backdrop-blur-md"
                >
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
              <Link
                to="/signup"
                className="group inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#2883CF] to-[#1e3a5f] px-7 py-3.5 text-base font-semibold text-white shadow-lg shadow-blue-900/30 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-900/40 sm:w-auto"
              >
                Start Free Trial
              ...
              <Link
                to="/login"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-[#1e3a5f]/30 bg-white/90 px-7 py-3.5 text-base font-semibold text-[#1e3a5f] shadow-md backdrop-blur-md transition-all hover:border-[#2883CF] hover:bg-white hover:text-[#2883CF] hover:shadow-lg sm:w-auto"
              >
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:gap-6 lg:justify-start">
              ...
              <div className="text-sm text-gray-800">
                ...
                <p className="mt-1">
                  <span className="font-bold text-[#0f2540]">10,000+</span>{' '}
          ...
          >
            ...
            <motion.img
              ...
              className="relative mx-auto h-auto w-full max-w-[560px] drop-shadow-2xl"
              animate={{ y: [0, -10, 0] }}
              transition={{
                duration: 5,
                repeat: Infinity,
