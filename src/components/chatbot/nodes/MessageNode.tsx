...
const MessageNode: React.FC<{ data: any }> = ({ data }) => {
  ...
  return (
    <div className={`px-4 py-3 bg-[#0a0e27] rounded-lg shadow-lg border-2 min-w-[200px] max-w-[280px] ${
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        {isWaiting && (
          <span className="ml-auto flex items-center gap-1 text-xs bg-orange-100 text-orange-600 px-1.5 py-0.5 rounded-full">
