...
import { Heart, Plus, Search, MessageSquare, Tag, Play, Pause } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-mono uppercase tracking-wider text-gray-500">Engagement</span>
          </div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Comment Automation</h1>
          <p className="text-sm text-gray-500 mt-1">Manage auto-replies for your posts and reels</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          {[
            ...
            <div key={i} className="rounded-2xl bg-gray-50 border border-gray-200 hover:border-gray-300 transition-all p-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="px-1.5 py-0.5 rounded bg-gray-50 border border-gray-200 text-[9px] text-gray-500">KW: {rule.keyword}</span>
                      <span className="px-1.5 py-0.5 rounded bg-gray-50 border border-gray-200 text-[9px] text-gray-500">{rule.type}</span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    <p className="text-xs font-bold text-gray-900">{rule.hits}</p>
                    <p className="text-[9px] text-gray-500">Automations</p>
                  </div>
                  <button className={`p-2 rounded-lg ${rule.status === 'active' ? 'text-green-400 bg-green-400/10' : 'text-gray-400 bg-gray-50'}`}>
                    {rule.status === 'active' ? <Play size={14} /> : <Pause size={14} />}
                  </button>
                </div>
              </div>
              <div className="pt-4 border-t border-gray-200 flex items-center justify-between text-[10px]">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-gray-50 border border-gray-200 p-5">
            <h3 className="text-sm font-bold text-gray-900 mb-4">Comment Performance</h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-500">Total Replies</span>
                <span className="text-xs font-bold text-gray-900">1,204</span>
              </div>
          ...
          <div className="rounded-2xl border border-dashed border-gray-200 p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-xs font-bold text-gray-900">Keyword Tip</h4>
            </div>
