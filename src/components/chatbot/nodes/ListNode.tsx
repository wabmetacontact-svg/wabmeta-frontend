  ...
  return (
    ...
    `}>
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="ml-auto text-[10px] text-indigo-500 bg-indigo-50 px-1.5 py-0.5 rounded-full">
          {totalRows} options
        </span>
      </div>
      ...
      {/* Menu Button */}
      <div className="mb-3">
        <span className="text-xs font-medium px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full border border-indigo-200">
      ...
      {/* Info */}
      <div className="mt-2 text-[10px] text-indigo-500 text-center">
