...
const CampaignDetails: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Failure Analysis ── */}
      {Boolean(displayStats && displayStats.failureReasons && displayStats.failureReasons.length > 0) && displayStats?.failureReasons && (
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input aria-label="Search by phone or name..."
              type="text"
          ...
          <select aria-label="Filter recipients by status"
            value={filterStatus}
